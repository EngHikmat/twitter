...
export default function Login(){
    ...
    return(
        <div className="container">
            ...
            <form>
                <input type="email" className="form-control lform" placeholder="Phone, email, or username" id="email"
                 value={email} onChange={e=>setEmail(e.target.value)}/>

                <input type="password" className="form-control mt-3 lform" placeholder="Password" id="pwd"
                value={password} onChange={e=>setPassword(e.target.value)}/>

                <button type="submit" className="btn btn-primary login " onClick={login}>Log in</button>
